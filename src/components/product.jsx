...
const Product = ({product, onAdd}) => {
    ...
    return (
        <div className="relative flex bg-white dark:bg-slate-800 text-gray-950 dark:text-gray-100 flex-col rounded-lg dark:shadow-gray-200
            ...
            <p className="text-xs font-open font-semibold">{product.price.toLocaleString()}/=</p>
